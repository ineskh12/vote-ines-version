@extends('layouts.app')
@section('pageTitle') Ajouter Critère @stop
...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Ajouter Critère</h3>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Ajouter Critère</h4>
                        <h6 class="card-subtitle">Ajouter les critére de vote au systéme </h6>
                        <form method="post" action="{{ route('criterias.store') }}" id="criteria_create" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" data-placeholder='Choisir catégorie' name="category_id" style="width: 100%; height:36px;">
                                                ...
                                                <option value="{{ $category->id }}-{{$category->event_id}}">{{ $category->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" data-placeholder='Choisir pourcentage' name="percentage_id" style="width: 100%; height:36px;">
                                                ...
                                                @foreach($percentages as $percentage)
                                                    <option value="{{ $percentage->id}}">{{ $percentage->titre_fr}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Coefficient
                                                ...
                                                <input name="coefficient" type="text" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
