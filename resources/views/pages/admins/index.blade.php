@extends('layouts.app')
@section('pageTitle') List Admins @stop
...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Liste des admins</h3>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admins.create') }}" class="waves-effect waves-light ribbon ribbon-success ribbon-right">Nouvel admin</a>
                        <h6 class="card-subtitle">Gérer les administrateur du systéme </h6>
                        <div class="table-responsive m-t-40">
                            <table id="admins-table" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Pays</th>
                                        <th>Avatar</th>
