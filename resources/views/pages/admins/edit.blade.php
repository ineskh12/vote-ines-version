@extends('layouts.app')
@section('pageTitle') Modifier Admin @stop
...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Modifier Admin</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admins.index') }}">Liste des admins</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Modifier Admin: <b>{{ $admin->name }} {{ $admin->prenom }}</b></h4>
                        <h6 class="card-subtitle">Modifier les information de compte admin </h6>
                        <form method="post" action="{{ route('admins.update', array('id'=>$admin->id)) }}" id="admin_edit"  data-id="{{ $admin->id }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                        ...
                                                        @if($admin->avatar != '' && File::exists(public_path().'/assets/uploads/admins/'.$admin->avatar) )
                                                             <img src="{{ asset('/assets/uploads/admins/'.$admin->avatar) }}"/>
                                                        @else
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nom" data-required="1" class="form-control"  value="{{ old('nom', $admin->name) }}" />
                                        </div>
                                        <div class="form-group">
