        ...
        <div class="container-fluid">
            ...
            <div class="login-register">
                <div class="login-box card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" id="reset_password" role="form" method="POST" action="{{ url('/password/reset') }}">
                             {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                <div class="col-xs-12">
                                    <input class="form-control" type="text" placeholder="Email" name="email" value="{{ $email or old('email') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                <div class="col-xs-12">
                                    <input class="form-control" type="password" placeholder="Confirm mot de passe" name="password_confirmation">
                                </div>
                            </div>

                            <div class="form-group text-center m-t-20">
                                <div class="col-xs-12">
                                    <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"> Reset mot de passe</button>
                                </div>
                            </div>
                            <div class="form-group m-b-0">
                                <div class="col-sm-12 text-center">
                                    <a href="{{ url('/login') }}" id="to-recover" class="text-dark pull-right">Annuler</a> 
                                </div>
                            </div>
                        </form>
                    </div>
