...
/*        .login-register{
            background: url('assets/login/OSC2018_Id.png');
            background-repeat: no-repeat;
            background-size: 50%;
            background-position: center;
        }*/
        #wrapper .container-fluid .row img{
...
<!--                     <img src="{{ asset('assets/login/cloud_left.png') }}"  class="img-left"/>
                    <img src="{{ asset('assets/login/cloud_right.png') }}" class="img-right"/> -->
                    <div class="card-body">
                        <form class="form-horizontal form-material" id="login" method="post" action="{{ url('/login') }}">
                             {{ csrf_field() }}
                            <h2 class="box-title m-b-20" style="text-align: center">Se connecter</h2>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <input class="form-control" type="password" placeholder="Mot de passe" name="password" value="{{ old('password') }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="checkbox checkbox-primary pull-left p-t-0">
                                        ...
                                        <label for="checkbox-signup"> Mémoriser mes informations </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-b-0">
                                <div class="col-sm-12 text-center">
                                    <a href="{{ url('/password/reset') }}" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Mot de passe oublié?</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <footer class="container-fluid w-100 bg-faded">
        <div class="row">
            ...
            <!-- <div class="col-md-4">
                <img src={{ asset("assets/login/OSC2018_Id.png") }} class="img-responsive" style="display: block; margin: auto;" />
            </div> -->
        </div>
    </footer>
    <!-- ============================================================== -->
